class EmployeesController < ApplicationController
  ...
  private
    ...
    def employee_params
      params.require(:employee).permit(:first_name, :last_name, :email, :user_name, :joining_date, :relieving_date, :emp_id, :citrix_id, :project, :manager, :admin_access, :citrix_access, :department, :document_signed, :beachhead_computrace)
    end
end
